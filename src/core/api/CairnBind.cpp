...
PYBIND11_MODULE(cairn, m) {
    ...
    py::class_<CairnAPI::OptimProblemAPI>(m, "OptimProblem")
        .def("export_parameters", &CairnAPI::OptimProblemAPI::export_Parameters, "exports the study parameters to a csv file", py::arg("filename") = "", py::arg("optionsMap") = py::dict())
    ...
    py::class_<CairnAPI::ObjectAPI> (m, "CairnObject")
        ...
        .def_property("setting_values", &CairnAPI::ObjectAPI::get_SettingValues, &CairnAPI::ObjectAPI::set_SettingValues, "get/set all parameters as a dictionary")
