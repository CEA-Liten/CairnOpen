...
PYBIND11_MODULE(cairn, m) {
    ...
    py::class_<CairnAPI::ObjectAPI, std::shared_ptr<CairnAPI::ObjectAPI>> (m, "CairnObject")
        ...
        .def("set_setting_comment", &CairnAPI::ObjectAPI::set_SettingComment, py::arg("name"), py::arg("comment"), py::arg("verify") = true, "sets the omment of a given parameter")
    ...
    py::class_<CairnAPI::SimulationControlAPI, CairnAPI::ObjectAPI, std::shared_ptr<CairnAPI::SimulationControlAPI>>(m, "SimulationControl")
        .def(py::init())       
        .def_property_readonly("reading_modes", &CairnAPI::SimulationControlAPI::get_ReadingModes, "a list of possible timeseries reading mode.")
        .def_property_readonly("rolling_modes", &CairnAPI::SimulationControlAPI::get_RollingModes, "a list of possible rolling modes.")
