...
PYBIND11_MODULE(cairn, m) {
    ...
    py::class_<CairnAPI::MilpComponentAPI>(m, "Component")
        ...
        .def("add_port", &CairnAPI::MilpComponentAPI::add_Port, py::arg("name"), py::arg("carrier"), py::arg("direction") = "DATAEXCHANGE", py::arg("variable") = "", "creates a new port for the component")
        ...
        .def_property_readonly("show_config", &CairnAPI::MilpComponentAPI::get_ShowConfig, "returns ShowConfig of a given parameter. The parameter is displayed in the GUI when this ShowConfig is selected in the DataFilter")
