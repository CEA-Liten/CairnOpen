...
void ManualConstraint::addExpressionToBalance(MIPModeler::MIPExpression1D& aFluxExpression)
{
...
void ManualConstraint::addExpressionToBalance(MIPModeler::MIPExpression &aFluxExpression)
{
    for (unsigned int t = 0; t < mHorizon ; ++t)
    {
