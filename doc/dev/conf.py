...
PERSEE_PATH = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../../lib/export/Persee/core/'))
sys.path.insert(0, os.path.join(PERSEE_PATH, "api"))
sys.path.append(os.path.join(PERSEE_PATH, "api"))
...
breathe_projects = {
"cairn": "./docs/doxygen/xml/",
}
breathe_default_project = "cairn"
