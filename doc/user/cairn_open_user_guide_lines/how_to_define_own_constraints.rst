...
-  you want to combine the operation of two production units, imposing an exclusion constraints on the two units (example 1 below),

-  you want to impose a yearly power partition between two production
   units (example 2 below)

Example 1: constraint for combining the operation of two production units 
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This is illustrated by the example below, and explained just below. To do this you must:
...
Example 2: constraint for imposing a yearly power partition between two production units
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
