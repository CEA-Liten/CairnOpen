...
/* This test reads study formation_persee_Edited.json and formation_persee_dataseries.csv.
   ...
   5- ModelClass of ELY_PEM is ElectrolyzerDetailed instead of Electrolyzer
   ...
   4- A componeent is correctly re-initialized (in particular its parameters) when its ModelClass changes.  
...
int main()
{
	...
	//Modify the ModelClass of ELY_PEM
	//CairnAPI::MilpComponentAPI ely_pem = m_Problem.get_Component("ELY_PEM");
	//TESTAPI("Modify the ModelClass of ELY_PEM",
	//	ely_pem.set_SettingValues({
