...
if __name__ == '__main__':
    ...
    if os.path.isfile(config_file):
        ...
        shutil.copy(os.getenv(
            'CAIRN_APP') + ut.getOSsep() + 'Scripts' + ut.getOSsep() + 'PerseeDocGen' + ut.getOSsep() + 'config_Extract_example.xml',
                    config_file)
    if os.path.isfile(app_home + ut.getOSsep() + colorfile) == False:
        shutil.copy(os.getenv(
            'CAIRN_APP') + ut.getOSsep() + 'Scripts' + ut.getOSsep() + 'PerseeDocGen' + ut.getOSsep() + 'config_Colors_example.csv',
                    colorfile)
    if os.path.isfile(app_home + ut.getOSsep() + "plotly.min.js") == False:
        shutil.copy(os.getenv(
            'CAIRN_APP') + ut.getOSsep() + 'Scripts' + ut.getOSsep() + 'PerseeDocGen' + ut.getOSsep() + 'plotly.min.js',
